...
import com.gentek.lib_audio.mediaplayer.core.AudioController.PlayMode;
...
import com.gentek.lib_audio.mediaplayer.view.adapter.MusicListAdapter;
...
public class MusicListDialog extends BottomSheetDialog {
     ...
     * data
     */
    private ArrayList<SongBean> mQueue; //播放队列
    ...
    private void initView() {
        ...
        mMusicListAdapter = new MusicListAdapter(mQueue, mSongBean, mContext);
    ...
    private void updateList() {
        mMusicListAdapter.updateAdapter(mSongBean);
    }
}
