package com.gentek.lib_audio.mediaplayer.db;
...
public class GreenDaoHelper {
   ...
   * 添加感兴趣
   */
  public static void addFavourite(SongBean songBean) {
    FavouriteDao dao = mDaoSession.getFavouriteDao();
    Favourite favourite = new Favourite();
    favourite.setSongId(songBean.getSong_id());
    favourite.setSongBean(songBean);
   ...
   * 移除感兴趣
   */
  public static void removeFavourite(SongBean songBean) {
    FavouriteDao dao = mDaoSession.getFavouriteDao();
    Favourite favourite =
        dao.queryBuilder().where(FavouriteDao.Properties.SongId.eq(songBean.getSong_id())).unique();
   ...
   * 查找感兴趣
   */
  public static Favourite selectFavourite(SongBean songBean) {
    FavouriteDao dao = mDaoSession.getFavouriteDao();
    Favourite favourite =
        dao.queryBuilder().where(FavouriteDao.Properties.SongId.eq(songBean.getSong_id())).unique();
    return favourite;
