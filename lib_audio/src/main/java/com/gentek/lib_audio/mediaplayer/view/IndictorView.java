...
import com.gentek.lib_audio.mediaplayer.view.adapter.MusicPagerAdapter;
...
public class IndictorView extends RelativeLayout implements ViewPager.OnPageChangeListener {
     ...
     * data
     */
    private SongBean mSongBean; //当前播放歌曲
    ...
    private void showLoadView(boolean isSmooth) {
        mViewPager.setCurrentItem(mQueue.indexOf(mSongBean), isSmooth);
    }
