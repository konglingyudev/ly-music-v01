package com.gentek.lib_image_loader.app;
...
import com.gentek.lib_image_loader.R;
import com.gentek.lib_image_loader.image.CustomRequestListener;
import com.gentek.lib_image_loader.image.Utils;
...
public class ImageLoaderManager {
    ...
    public void displayImageForView(ImageView imageView, String url,
        ...
        Glide.with(imageView.getContext())
                ...
                .transition(withCrossFade())//图片加载切换效果
                .into(imageView);
    }
     ...
     * @param group
     * @param url
     * @param isVague 是否模糊处理 true-模糊
     */
    public void displayImageForViewGroup(final ViewGroup group, String url, final boolean isVague) {
                    ...
                    public void onResourceReady(@NonNull Bitmap resource,
                        ...
                        Observable.just(resource)
                                .map(new Function<Bitmap, Drawable>() {
                                    // 将Bitmap进行模糊处理并转成drawable
                                    @Override
                                    public Drawable apply(Bitmap bitmap) {
                                        Drawable drawable = null;
                                        if (isVague) {
                                            drawable = new BitmapDrawable(
                                                    Utils.doBlur(res, 100, true)//高斯模糊
                                            );
                                        } else {
                                            drawable = new BitmapDrawable();
                                        }
                                ...
                                .subscribeOn(Schedulers.io())//指定在io主线程
    ...
    private RequestOptions initCommonRequestOption() {
        ...
        options.placeholder(R.mipmap.b4y)                           //占位图
                ...
                .skipMemoryCache(false)                             // 内存缓存 false 使用
